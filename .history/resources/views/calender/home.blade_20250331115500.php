...
<a class="month_toggle" href="{{ route('admin.calendar.show', ['year' => $prevYear, 'month' => $prevMonth]) }}">◀</a>
    {{ $year }}年 {{ $month }}月
<a class="month_toggle" href="{{ route('admin.calendar.show', ['year' => $nextYear, 'month' => $nextMonth]) }}">▶</a>
