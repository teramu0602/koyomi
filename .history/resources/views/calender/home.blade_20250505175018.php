...
<table>
    ...
    && $event->calendar_groups->isEmpty(); // 個人の予定かどうかを識別
            ...
            <div class = "calendar_title">
                @foreach($e as $event)
                <div style="background-color: {{ $event->color }}; padding: 4px 8px; margin-bottom: 4px; border-radius: 4px; color: black; font-size: 0.9rem; font-family: 'Meiryo', 'Hiragino Kaku Gothic ProN', sans-serif; display: inline-block; width: 100%; box-sizing: border-box;">
    <a href="{{ route('group.details', ['id' => $event->id]) }}" style="color: black; text-decoration: none; display: inline-block; width: 100%;">
        {{ $event->title }}
    </a>
</div>
