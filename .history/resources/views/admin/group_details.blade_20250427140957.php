...
@section('content')
    ...
    @endif
        ...
        <p>日付: {{ \Carbon\Carbon::parse($event->event_start_date)->format('Y年m月d日') }}
        @if ($event->event_end_date)
            ~{{ \Carbon\Carbon::parse($event->event_end_date)->format('Y年m月d日') }}</p>
        @endif
        {{ \Carbon\Carbon::parse($event->event_start_time)->format('Y年m月d日') }}
